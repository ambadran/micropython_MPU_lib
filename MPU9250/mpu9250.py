...
class MPU9250:
    ...
    def __init__(self, accel_sensitivity_ind, gyro_range_ind):
        ...
        self.mag_offset = []  #TODO: figure this out
...
#         return degrees(atan2(hs[1], hs[0]))  # no
    ...
    def angles_absolute(self):
        ...
        result.append(self.tesla_to_angle())
        return result
...
#         mag_angle = self.tesla_to_angle()  # Absolute Yaw
...
#         mag_side = self.complK * mag_angle
#         gyro_side = self.complK_I * ( self.angles_compl[2] + gyro[2] * self.compl_period/1000 )
#         self.angles_compl[2] = mag_side + gyro_side
